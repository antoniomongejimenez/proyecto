<x-app-layout>
    ...
    <x-plantilla>
        <form action="{{ route('deportes.update', [$deporte], false) }}" method="POST"
            ...
            <div class="mb-6">
                ...
                <input type="text" name="denominación" id="denominación"
                    ...
                    value="{{ old('denominación', $deporte->denominación) }}">
                @error('denominación')
            ...
            <a href="/deportes" class="mt-4 text-blue-900 hover:underline">Volver</a>
        </form>
    </x-plantilla>
</x-app-layout>
