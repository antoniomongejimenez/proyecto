                            ...
                            <tbody>
                                @foreach ($tipos as $tipo)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4">
                                           <a href="{{ route('tipos.edit', $tipo) }}" class="mt-4 text-blue-900 hover:underline">Editar</a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="{{ route('tipos.show', $tipo) }}" class="mt-4 text-blue-900 hover:underline">Mostrar</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
