<x-app-layout>
    ...
    <x-plantilla>
        <form action="{{ route('productos.update', [$producto], false) }}" method="POST"
            ...
            <div class="mb-4">
                ...
                <select name="deporte_id" id="deporte_id">
                    <option value="{{$producto->deporte->id}}">{{$producto->deporte->denominación}}</option>
                    @foreach ($deportes as $deporte)
                        @if ($producto->deporte->id != $deporte->id)
            ...
            <div class="mb-6">
                ...
                <select name="tipo_id" id="tipo_id">
                    <option value="{{$producto->tipo->id}}">{{$producto->tipo->denominación}}</option>
                    @foreach ($tipos as $tipo)
                        @if ($producto->tipo->id != $tipo->id)
            ...
            <div class="mb-6">
                ...
                <select name="marca_id" id="marca_id">
                    <option value="{{$producto->marca->id}}">{{$producto->marca->denominación}}</option>
            ...
            <div class="mb-6">
                ...
                <select name="tipos_persona_id" id="tipos_persona_id">
                    <option value="{{$producto->tiposPersona->id}}">{{$producto->tiposPersona->denominación}}</option>
                    @foreach ($tiposPersonas as $tiposPersona)
                        @if ($producto->tiposPersona->id != $tiposPersona->id)
