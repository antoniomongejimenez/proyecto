<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Editar tipo de persona') }}
        </h2>
    </x-slot>
    <x-plantilla>
        <form action="{{ route('tipospersonas.update', [$tipospersona], false) }}" method="POST"
            ...
            <div class="mb-6">
                ...
                <input type="text" name="denominación" id="denominación"
                    ...
                    value="{{ old('denominación', $tipospersona->denominación) }}">
                @error('denominación')
            ...
            <a href="/tipospersonas" class="mt-4 text-blue-900 hover:underline">Volver</a>
        </form>
    </x-plantilla>
</x-app-layout>
