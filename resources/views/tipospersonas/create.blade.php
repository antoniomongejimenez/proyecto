<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Crear tipo de persona') }}
        </h2>
    </x-slot>
    <x-plantilla>
        <form action="{{ route('tipospersonas.store', [], false) }}" method="POST"
            ...
            <div class="mb-6">
                ...
                <input type="text" name="denominación" id="denominación"
                    ...
                    value="{{ old('denominación', $tipoPersona->denominación) }}">
                @error('denominación')
        ...
        <form action="{{ route('tipospersonas.index') }}">
